...
const AlertContent = ({ type }) => {
	...
	useEffect(() => {
		switch (type) {
			case "hideHelp":
				setTextContent("Başlamak için 'help' yazın");
				break;
			case "qemu":
				setTextContent(
					"Bu sayfa hâlâ geliştirme aşamasındadır. Sorun yaşarsanız sayfayı yenileyin."
				);
				break;
			default:
				setTextContent("Uyarı mesajı yüklenemedi.");
				break;
		}
