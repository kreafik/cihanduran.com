...
const AlertContent = ({ type }) => {
	...
	useEffect(() => {
		switch (type) {
			...
			case "qemu":
				setTextContent(
					"This pag is still under development! You might experience visual glitches, ROM issues, etc. On top of that, since it downloads a 16.8 mb OS image, it might take a while to work properly. In such circumstances, try refreshing the page. If you're still having issues, please open an issue on GitHub."
				);
				break;
			default:
